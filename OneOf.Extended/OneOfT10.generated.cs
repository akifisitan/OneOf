...
namespace OneOf
{
    public readonly struct OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : IOneOf
    {
        ...
        public async Task<OneOf<TResult, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> MapT0<TResult>(Func<T0, Task<TResult>> mapFunc)
        {
            if (mapFunc == null)
            {
                throw new ArgumentNullException(nameof(mapFunc));
        ...
        public async Task<OneOf<T0, TResult, T2, T3, T4, T5, T6, T7, T8, T9, T10>> MapT1<TResult>(Func<T1, Task<TResult>> mapFunc)
        {
            if (mapFunc == null)
            {
                throw new ArgumentNullException(nameof(mapFunc));
        ...
        public async Task<OneOf<T0, T1, TResult, T3, T4, T5, T6, T7, T8, T9, T10>> MapT2<TResult>(Func<T2, Task<TResult>> mapFunc)
        {
            if (mapFunc == null)
            {
                throw new ArgumentNullException(nameof(mapFunc));
        ...
        public async Task<OneOf<T0, T1, T2, TResult, T4, T5, T6, T7, T8, T9, T10>> MapT3<TResult>(Func<T3, Task<TResult>> mapFunc)
        {
            if (mapFunc == null)
            {
                throw new ArgumentNullException(nameof(mapFunc));
        ...
        public async Task<OneOf<T0, T1, T2, T3, TResult, T5, T6, T7, T8, T9, T10>> MapT4<TResult>(Func<T4, Task<TResult>> mapFunc)
        {
            if (mapFunc == null)
            {
                throw new ArgumentNullException(nameof(mapFunc));
        ...
        public async Task<OneOf<T0, T1, T2, T3, T4, TResult, T6, T7, T8, T9, T10>> MapT5<TResult>(Func<T5, Task<TResult>> mapFunc)
        {
            if (mapFunc == null)
            {
                throw new ArgumentNullException(nameof(mapFunc));
        ...
        public async Task<OneOf<T0, T1, T2, T3, T4, T5, TResult, T7, T8, T9, T10>> MapT6<TResult>(Func<T6, Task<TResult>> mapFunc)
        {
            if (mapFunc == null)
            {
                throw new ArgumentNullException(nameof(mapFunc));
        ...
        public async Task<OneOf<T0, T1, T2, T3, T4, T5, T6, TResult, T8, T9, T10>> MapT7<TResult>(Func<T7, Task<TResult>> mapFunc)
        {
            if (mapFunc == null)
            {
                throw new ArgumentNullException(nameof(mapFunc));
        ...
        public async Task<OneOf<T0, T1, T2, T3, T4, T5, T6, T7, TResult, T9, T10>> MapT8<TResult>(Func<T8, Task<TResult>> mapFunc)
        {
            if (mapFunc == null)
            {
                throw new ArgumentNullException(nameof(mapFunc));
        ...
        public async Task<OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, TResult, T10>> MapT9<TResult>(Func<T9, Task<TResult>> mapFunc)
        {
            if (mapFunc == null)
            {
                throw new ArgumentNullException(nameof(mapFunc));
        ...
        public async Task<OneOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>> MapT10<TResult>(Func<T10, Task<TResult>> mapFunc)
        {
            if (mapFunc == null)
            {
                throw new ArgumentNullException(nameof(mapFunc));
